package com.atmecs.GitDemo.testscript;
...
import com.atmecs.GitDemo.constant.FilePathConstants;
import com.atmecs.GitDemo.constant.LocatorKeyContainer;
import com.atmecs.GitDemo.testsuite.SampleTestSuiteBase;
import com.atmecs.locatorSmartFixTool.models.SmartFixPageFileHandler;

public class GitDemo extends SampleTestSuiteBase {
	private ReportLogService report = new ReportLogServiceImpl(GitDemo.class);
